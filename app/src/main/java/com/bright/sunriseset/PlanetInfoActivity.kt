...
class PlanetInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.lang.text = getString(R.string.btn_text)
//        if(resources.configuration.locale.country == "CN") {
//
//        } else {
//            binding.lang.text = "Chinese"
//        }
    ...
    private fun updateLocale() {
        val targetLocale = if(resources.configuration.locale.country == "CN") {
            Locale("en", "US")
        } else {
            Locale("zh", "CN")
        }
...
//        val sdf = SimpleDateFormat("hh:mm a", Locale(userPreferredLanguage))
        ...
        val sdf = SimpleDateFormat("hh:mm a", Locale(resources.configuration.locale.language))
